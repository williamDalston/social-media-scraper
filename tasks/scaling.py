...
def implement_auto_scaling():
    ...
    if recommendation['scale_up']:
        ...
        logger.info(f"Auto-scaling: Scale up from {current_workers} to {target_workers} workers")
        ...
        # Scale down logic
        logger.info(f"Auto-scaling: Scale down from {current_workers} to {target_workers} workers")
