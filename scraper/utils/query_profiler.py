...
class QueryProfiler:
    ...
    def record_query(self, statement: str, duration: float, error: Optional[Exception] = None):
        """
    ...
    def get_recommendations(self) -> List[str]:
        ...
        for normalized, count in sorted(
            ...
            if count > 100:
                avg_time = sum(self.query_times[normalized]) / len(self.query_times[normalized])
