...
class AnomalyDetector:
    ...
    def __init__(self):
        ...
        ] = {}  # account_key -> list of snapshots
        logger.info("Initialized AnomalyDetector")

    def _calculate_z_score(
        self, value: float, mean_val: float, std_val: float
    ) -> float:
        """
    ...
    def detect_anomalies(
        self, account_key: int, current_data: Dict[str, Any], threshold: float = 3.0
    ) -> Dict[str, Any]:
        """
    ...
    def add_historical_data(
        self, account_key: int, snapshot_data: Dict[str, Any], max_history: int = 30
    ):
        """
        ...
        if len(self._historical_data[account_key]) > max_history:
            self._historical_data[account_key] = self._historical_data[account_key][
                -max_history:
            ]
