...
POSITIVE_WORDS = {
    ...
    'perfect', 'superb', 'terrific', 'fabulous', 'marvelous', 'delightful',
    'happy', 'joy', 'pleased', 'glad', 'thrilled', 'excited', 'proud',
    'success', 'achievement', 'win', 'victory', 'triumph', 'celebration',
    'thank', 'grateful', 'appreciate', 'support', 'help', 'care',
}

NEGATIVE_WORDS = {
    'bad', 'terrible', 'awful', 'horrible', 'worst', 'hate', 'dislike',
    'disappointed', 'sad', 'angry', 'frustrated', 'upset', 'worried',
    'concerned', 'problem', 'issue', 'error', 'fail', 'failure', 'mistake',
    'wrong', 'difficult', 'hard', 'challenge', 'struggle', 'crisis',
    'emergency', 'danger', 'risk', 'threat', 'attack', 'violence',
    'complaint', 'criticize', 'blame', 'fault', 'damage', 'harm',
}
