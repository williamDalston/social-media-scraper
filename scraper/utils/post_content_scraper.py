...
class PostContentScraper:
    ...
    def _extract_text(self, soup, platform: str) -> str:
        ...
        if platform in ['x', 'twitter']:
            # X/Twitter post text
            text_elements = soup.find_all(['p', 'span'], class_=re.compile(r'text|tweet', re.I))
        elif platform == 'instagram':
            # Instagram caption
            text_elements = soup.find_all(['span', 'div'], class_=re.compile(r'caption|text', re.I))
        else:
            # Generic text extraction
            text_elements = soup.find_all(['p', 'div', 'span'], class_=re.compile(r'content|text|post', re.I))
    ...
    def extract_media_metadata(
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if media_type == 'image' and 'image' in metadata.get('content_type', ''):
