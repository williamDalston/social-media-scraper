...
class DuplicateDetector:
    ...
    def _hash_data(self, data: Dict[str, Any]) -> str:
        ...
        normalized = {
            ...
            if v is not None
            and k not in ["post_datetime_utc", "snapshot_date"]  # Exclude timestamps
        }
    ...
    def is_duplicate_post(
        self, platform: str, post_id: str, post_data: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
        ...
        if post_data:
            ...
            if content_hash in self._seen_hashes:
                logger.debug(
                    f"Duplicate post detected by content hash: {platform}:{post_id}"
                )
                return True
    ...
    def is_duplicate_snapshot(
        self, account_key: int, snapshot_data: Dict[str, Any]
    ) -> bool:
        """
