...
class CriticalAlertManager:
    ...
    def create_alert(
        ...
        logger.critical(
            ...
            extra={"alert_id": alert_id, "severity": severity, "source": source},
        )
            ...
            for anomaly in critical_anomalies:
                ...
                existing = next(
                    (
                        ...
                        for a in self.alerts
                        if a.source == "anomaly"
                        and a.source_id == anomaly.metric_name
            ...
            for incident in critical_incidents:
                ...
                existing = next(
                    (
                        ...
                        and a.source_id == incident.incident_id
                        and not a.resolved
                    ),
                    None,
                )
                ...
                if result.status != "healthy":
                    ...
                    if not existing:
                        ...
                        self.create_alert(
                            ...
                            or f"Health check {name} is {result.status}",
                            severity=severity,
                            source="health",
                            source_id=name,
                        )
