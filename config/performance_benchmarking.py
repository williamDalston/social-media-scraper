...
class PerformanceBenchmarker:
    ...
    def compare_to_benchmark(self, benchmark_name: str, current_value: float) -> Optional[BenchmarkResult]:
        """
        ...
        if benchmark.unit in ['ms', 's', 'MB']:
            baseline_diff = ((benchmark.baseline_value - current_value) / benchmark.baseline_value * 100)
            target_diff = ((benchmark.target_value - current_value) / benchmark.target_value * 100)
            ...
            baseline_diff = ((current_value - benchmark.baseline_value) / benchmark.baseline_value * 100)
            target_diff = ((current_value - benchmark.target_value) / benchmark.target_value * 100)
