...
scraper_accounts_scraped = Counter(
    'scraper_accounts_scraped',
    'Total accounts scraped',
    ['platform', 'status']
)
...
latest_snapshot_date = Gauge(
    'latest_snapshot_date_timestamp',
    'Timestamp of the latest snapshot date'
)

# Parallel scraping metrics
parallel_scraping_workers = Gauge(
    'parallel_scraping_workers',
    'Number of parallel workers used for scraping'
)
...
def record_scraper_run(mode, status, duration, accounts_scraped=None, parallel=False, max_workers=None, accounts_per_second=None):
    """
