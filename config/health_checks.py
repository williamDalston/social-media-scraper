...
class HealthCheckResult:
    ...
    def __init__(self, name: str, status: str, message: str = "", 
                 details: Optional[Dict] = None, response_time: float = 0.0):
        self.name = name
...
def check_disk_space(path: str = '/', threshold_percent: float = 90.0) -> HealthCheckResult:
    """
...
def run_health_checks(db_path: Optional[str] = None, 
                      include_optional: bool = True,
                      use_cache: bool = True) -> Dict[str, HealthCheckResult]:
    """
