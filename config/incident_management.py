...
class IncidentManager:
    ...
    def add_timeline_entry(
        self, incident_id: str, action: str, user: str, description: str
    ):
    ...
    def create_on_call_rotation(
        self, rotation_id: str, name: str, members: List[str]
    ) -> OnCallRotation:
        """Create an on-call rotation."""
        rotation = OnCallRotation(rotation_id=rotation_id, name=name, members=members)
