...
class TestFaultTolerance:
    ...
    def test_error_isolation(self, db_session):
        ...
        try:
            account2 = DimAccount(platform='X', handle='isolation_test_2', org_name=None)
            # Force an error
        ...
        retrieved = db_session.query(DimAccount).filter_by(handle='isolation_test_1').first()
