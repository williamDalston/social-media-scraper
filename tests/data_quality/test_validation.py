...
class TestDataValidation:
    ...
    def test_engagement_validation(self, db_session, sample_account):
        ...
        calculated = snapshot.likes_count + snapshot.comments_count + snapshot.shares_count
    ...
    def test_platform_validation(self, db_session):
        ...
        valid_platforms = ['X', 'Instagram', 'Facebook', 'YouTube', 'LinkedIn', 'Truth Social']
...
class TestDataConsistency:
    ...
    def test_account_handle_consistency(self, db_session):
        ...
        assert 'consistent_test' in account.account_url or account.handle == 'consistent_test'
