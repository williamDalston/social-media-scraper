...
class TestDataValidation:
    ...
    def test_validate_followers_count(self):
        ...
        assert validator._validate_followers(1000000000, 'X', 'test')[0] == False  # Too high
    ...
    def test_validate_engagement_metrics(self):
        ...
        assert validator._validate_engagement(20000000, 'X', 'test')[0] == False  # Too high
...
class TestDataAccuracy:
    ...
    def test_follower_count_accuracy(self):
        ...
        for count, expected_valid in test_cases:
            ...
            assert is_valid == expected_valid, f"Follower count {count} validation failed"
...
class TestDataCompleteness:
    ...
    def test_required_fields_present(self):
        ...
        for field in required_fields:
            ...
            assert is_valid == False
            assert any(f'missing required field' in err.lower() or field in err.lower() for err in errors)
