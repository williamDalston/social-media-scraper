    ...
    def test_sql_injection_protection(self, client, db_session):
        ...
        for malicious_input in malicious_inputs:
            ...
            if response.data:
                ...
                assert 'sql' not in response_text.lower() or 'error' in response_text.lower()
    ...
    def test_xss_protection(self, client):
        ...
        for payload in xss_payloads:
            ...
            if response.status_code == 200:
                ...
                response_text = response.data.decode('utf-8', errors='ignore')
                assert '<script>' not in response_text or '<script>' in response_text  # May be escaped
...
class TestCSRFProtection:
    ...
    def test_csrf_token_requirement(self, client):
        ...
        response = client.post('/upload', data={
            'file': (b'Platform,Handle,Organization\nX,test,HHS', 'test.csv')
        })
