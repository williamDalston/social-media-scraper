...
class TestDashboardE2E:
    ...
    def test_dashboard_displays_data(self, page: Page, live_server, db_session, sample_account):
...
class TestAPIE2E:
    ...
    def test_api_summary_endpoint(self, page: Page, live_server, db_session, sample_account):
