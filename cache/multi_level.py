        ...
        if self.l2_available:
            try:
                ...
                if value is not None:
                    ...
                    try:
                        ...
                        record_cache_operation(
                            "get", key, "l2", duration, success=False
                        )
                    except Exception:
                        pass
                ...
                try:
                    ...
                    record_cache_operation(
                        "get", key, "l2", duration, success=False, error=str(e)
                    )
                except Exception:
                    pass
    ...
    def set(self, key: str, value: Any, ttl: Optional[int] = None):
        ...
        try:
            ...
            try:
                ...
                record_cache_operation(
                    "set", key, "l1", l1_duration, success=False, error=str(e)
                )
            except Exception:
                pass
        ...
        if self.l2_available:
            try:
                ...
                try:
                    ...
                    record_cache_operation(
                        "set", key, "l2", l2_duration, success=False, error=str(e)
                    )
                except Exception:
                    pass
