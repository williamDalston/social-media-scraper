...
class CacheAnalytics:
    ...
    def record_operation(
        self, operation: str, key: str, hit: bool, duration: float = 0
    ):
        """
                ...
                return {
                    ...
                    "by_pattern": {
                        pattern: {
                            ...
                            "total": self.hits_by_pattern[pattern]
                            + self.misses_by_pattern[pattern],
                            "hit_rate": (
                                (
                        ...
                        for pattern in set(
                            list(self.hits_by_pattern.keys())
                            + list(self.misses_by_pattern.keys())
                        )
                    },
                }
