...
class AccountSchema(Schema):
    ...
    platform = fields.Str(
        ...
        validate=validate.OneOf(
            ["X", "Instagram", "Facebook", "LinkedIn", "YouTube", "Truth Social"]
        ),
    )
...
class RegisterSchema(Schema):
    ...
    role = fields.Str(
        validate=validate.OneOf(["Admin", "Editor", "Viewer"]), missing="Viewer"
    )
