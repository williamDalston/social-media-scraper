...
production_bp = Blueprint(
    "production_monitoring", __name__, url_prefix="/api/production"
)
...
def get_business_metrics():
    ...
    try:
        ...
        return jsonify({"metrics": summary, "timestamp": datetime.utcnow().isoformat()})
    except Exception as e:
...
def get_production_status():
    ...
    try:
        ...
        critical_incidents = [
            i for i in open_incidents if i.severity.value == "critical"
        ]
