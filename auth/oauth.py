...
def list_providers():
    ...
    if os.getenv('GOOGLE_CLIENT_ID'):
        providers.append({
            'name': 'google',
            'display_name': 'Google',
            'authorize_url': url_for('oauth.authorize', provider='google', _external=True)
        })
    ...
    if os.getenv('MICROSOFT_CLIENT_ID'):
        providers.append({
            ...
            'authorize_url': url_for('oauth.authorize', provider='microsoft', _external=True)
        })
    ...
    if os.getenv('GITHUB_CLIENT_ID'):
        providers.append({
            'name': 'github',
            'display_name': 'GitHub',
            'authorize_url': url_for('oauth.authorize', provider='github', _external=True)
        })
